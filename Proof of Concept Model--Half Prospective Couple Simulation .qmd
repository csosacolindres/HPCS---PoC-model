...
modelMeansPlot <- ggplot(data = modelMeans, 
  ...
  stat_summary(fun = mean,
               geom = "bar",
               position = "dodge") +
  labs(title = "HPCS proof-of-concept results", 
       subtitle = "Mean partner similarities for mate choice model combinations", 
       x = "True Mate Choice (T2 mate choice models)",
       y = "Mean Partner Similarities (1 = identical)", 
       fill = "Predicted Mate Choice\n(T1 mate choice models)")
