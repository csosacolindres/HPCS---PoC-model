...
cbp1 <- c("#0072B2", "#999999", "#E69F00", "#56B4E9", "#009E73",
...
# how many participants will i need? Using "Predictive Validity of Partners Preferences" in Gerlach et al. (2019)
pwr.t.test(d = .2, sig.level = .05, power = .8)
pwr.t.test(n = 1000, sig.level = .05, power = .8)

# 33.8% of T2 partners coupled
394/.3381

# 49.45% of participants responded both T1 and T2
1166/.4945

# Total sample size per group I need to collect: 
2358
```
